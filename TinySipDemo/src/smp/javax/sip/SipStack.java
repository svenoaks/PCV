 ...
 * application implementing the {@link smp.javax.sip.SipListener} interface to
 * control the architecture and setup of the SIP stack. These methods include:
 * <ul>
 * <li>Creation/deletion of {@link smp.javax.sip.SipProvider}'s that represent
 * messaging objects that can be used by an application to send
 * {@link smp.javax.sip.message.Request}and {@link smp.javax.sip.message.Response}
 * messages statelessly or statefully via Client and Server transactions.
 * <li>Creation/deletion of {@link smp.javax.sip.ListeningPoint}'s that represent
 ...
 * convention defined in {@link smp.javax.sip.SipFactory}, the implementation of
...
public interface SipStack {
     ...
     * {@link smp.javax.sip.TimeoutEvent}'s, however an application will be
