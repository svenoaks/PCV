 ...
 * {@link smp.javax.sip.SipProvider}interface.
 * <p>
 ...
 * An application can send messages by passing {@link smp.javax.sip.message.Request}
 * and {@link smp.javax.sip.message.Response}messages to that the following object:
 * <ul>
 * <li>Request and response messages can be sent statelessly via the
 * SipProvider using the send methods on the {@link smp.javax.sip.SipProvider}.
