 ...
 * {@link smp.javax.sip.message.Request}'s statefully. A new client transaction 
...
public interface ClientTransaction extends Transaction {
     ...
     * the {@link smp.javax.sip.message.MessageFactory} and then creates a new
     ...
     * {@link smp.javax.sip.Timeout#TRANSACTION} and the client should then consider the
