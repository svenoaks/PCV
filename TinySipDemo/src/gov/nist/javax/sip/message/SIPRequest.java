...
import smp.javax.sip.address.URI;
...
public final class SIPRequest extends SIPMessage implements smp.javax.sip.message.Request {
     ...
     */
    public smp.javax.sip.address.URI getRequestURI() {
        if (this.requestLine == null)
            return null;
        else
            return (smp.javax.sip.address.URI) this.requestLine.getUri();
    }
