 ...
 *
 */
public class AddressFactoryImpl implements smp.javax.sip.address.AddressFactory {
	...
	public smp.javax.sip.address.Address createAddress() {
	 ...
	 */
	public smp.javax.sip.address.SipURI createSipURI(String uri)
	 ...
	 *@param host -- the host.
	 */
	public smp.javax.sip.address.SipURI createSipURI(String user, String host)
		throws ParseException {
		if (host == null)
	 ...
	 */
	public smp.javax.sip.address.TelURL createTelURL(String uri)
		throws ParseException {
		if (uri == null)
	...
	public smp.javax.sip.address.Address createAddress(smp.javax.sip.address.URI uri) {
		if (uri == null)
	 ...
	 */
	public smp.javax.sip.address.Address createAddress(String address)
	...
	public smp.javax.sip.address.URI createURI(String uri) throws ParseException {
		if (uri == null)
		...
		try {
			...
			if (scheme.equalsIgnoreCase("sip")) {
				return (smp.javax.sip.address.URI) urlParser.sipURL();
			} else if (scheme.equalsIgnoreCase("sips")) {
				return (smp.javax.sip.address.URI) urlParser.sipURL();
			} else if (scheme.equalsIgnoreCase("tel")) {
				return (smp.javax.sip.address.URI) urlParser.telURL();
			}
		} catch (ParseException ex) {
			throw new ParseException(ex.getMessage(), 0);
		}
