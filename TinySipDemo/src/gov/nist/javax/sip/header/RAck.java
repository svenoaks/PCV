 ...
 * 
 * @version 1.2 $Revision: 1.6 $ $Date: 2006/08/15 21:44:51 $
 * 
 * @author M. Ranganathan <br/>
 * 
 * 
 */
public class RAck extends SIPHeader implements smp.javax.sip.header.RAckHeader {
	...
	/**
	 * @deprecated
	 * @see smp.javax.sip.header.RAckHeader#setCSeqNumber(int)
	 */
	...
	/**
	 *@deprecated
	 * @see smp.javax.sip.header.RAckHeader#setRSeqNumber(int)
	 */
