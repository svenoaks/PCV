...
public class HeaderFactoryImpl implements HeaderFactory , HeaderFactoryExt {
	...
	*/
	 ...
	 */
	public smp.javax.sip.header.ExtensionHeader createExtensionHeader(
		String name,
		String value)
		throws ParseException {
		if (name == null)
	...
	*/
	...
	public MimeVersionHeader createMimeVersionHeader(
		...
		if (majorVersion < 0 || minorVersion < 0)
			throw new smp.javax.sip.InvalidArgumentException(
	...
	/**
	 * @deprecated
	 * @see smp.javax.sip.header.HeaderFactory#createRAckHeader(int, int, java.lang.String)
	 */
	...
	/**
	 * @deprecated
	 * @see smp.javax.sip.header.HeaderFactory#createRSeqHeader(int)
	 */
	...
	*/
	 ...
	 */
	public smp.javax.sip.header.Header createHeader(
		String headerName,
		String headerValue)
