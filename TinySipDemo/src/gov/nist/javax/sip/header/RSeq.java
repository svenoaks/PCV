...
import smp.javax.sip.header.ExtensionHeader;

/**
 *
 * @version 1.2 $Revision: 1.5 $ $Date: 2006/08/15 21:44:52 $
 *
 * @author M. Ranganathan   <br/>
 *
 * 
 */
public class RSeq extends SIPHeader implements smp.javax.sip.header.RSeqHeader {
	/**
	...
	/**
	 * @deprecated 
	 * @see smp.javax.sip.header.RSeqHeader#setSequenceNumber(int)
	 */
