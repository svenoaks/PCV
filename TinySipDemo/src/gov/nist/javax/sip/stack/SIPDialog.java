...
public class SIPDialog implements smp.javax.sip.Dialog, DialogExt {
    ...
    private smp.javax.sip.address.Address localParty;

    private smp.javax.sip.address.Address remoteParty;
    ...
    public smp.javax.sip.address.Address getLocalParty() {
     ...
     */
    public smp.javax.sip.address.Address getRemoteParty() {
     ...
     */
    public smp.javax.sip.address.Address getRemoteTarget() {
