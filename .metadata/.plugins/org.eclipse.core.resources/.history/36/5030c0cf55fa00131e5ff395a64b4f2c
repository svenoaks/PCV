...
const char *registrar  = "sip:smptestsip.sip.twilio.com";
const char *uri  = "sip:smptestsip.sip.twilio.com";
const char *name = "svenoaks";
...
int make_call()
{
	...
	if (true) {
		...
		err = sipsess_connect(&sess, sess_sock, uri, name,
				      uri, name,
